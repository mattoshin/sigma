  ...
  return (
    <Panel>
      <PanelHeader>
        ...
        <span className="mono text-[12px] text-faint">CIK {facts.cik}</span>
      </PanelHeader>
      <PanelBody className="space-y-3">
        {facts.metrics.length > 0 ? (
          ...
          <p className="text-[13px] text-faint">No headline fundamentals available.</p>
        )}

        {facts.latestFilings.length > 0 && (
          <div>
            <div className="mb-1 text-[12px] uppercase tracking-wider text-faint">Recent filings</div>
