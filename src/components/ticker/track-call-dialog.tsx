    ...
    >
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[min(440px,92vw)] -translate-x-1/2 -translate-y-1/2 rounded-md border border-line2 bg-panel p-4 shadow-2xl">
          <Dialog.Title className="text-sm font-semibold text-fg">Track a probabilistic call</Dialog.Title>
          <Dialog.Description className="mt-1 text-[11px] leading-snug text-muted">
          ...
          {done ? (
            <div className="mt-4 space-y-3">
              <div className="flex items-center gap-2 rounded-sm border border-up/40 bg-up/10 px-3 py-2 text-xs text-up">
            ...
            <div className="mt-4 space-y-4">
              <div className="rounded-sm border border-line bg-panel2 px-3 py-2">
                <div className="mono text-xs text-fg">{claim}</div>
              </div>
