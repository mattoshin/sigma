...
export const metadata = { title: "Methodology · Riptide" };
    ...
    <div className="mx-auto max-w-3xl px-6 py-8">
      ...
      <Section id="thesis" title="The thesis">
        <p>
          ...
          the opposite of how a derivatives desk thinks. Riptide flips the unit of research from a
...
Continuous:  f* = (μ − r) / σ²`}</Formula>
      ...
      <Section id="data" title="Data & honesty">
        <p>
          ...
          snapshots so it can&apos;t break live; flip <span className="mono">RIPTIDE_FORCE_LIVE=1</span>{" "}
          ...
          assumes you already have Bloomberg and proprietary analytics; Riptide adds the one reasoning
