 ...
 * Set RIPTIDE_FORCE_LIVE=1 to prefer live data (with snapshot fallback on error).
 */
export const DEMO_SNAPSHOT_FIRST =
  (process.env.RIPTIDE_FORCE_LIVE ?? process.env.OSHIN_FORCE_LIVE) !== "1";
